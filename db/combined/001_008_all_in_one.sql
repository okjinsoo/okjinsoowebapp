...
BEGIN
  ...
  IF EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'app_state_snapshots'
      AND policyname = 'app_state_snapshots_write_main_authenticated'
  ) THEN
    DROP POLICY app_state_snapshots_write_main_authenticated ON public.app_state_snapshots;
  END IF;
  ...
  IF EXISTS (
    ...
    WHERE schemaname = 'public'
      AND tablename = 'app_state_snapshots'
      AND policyname = 'app_state_snapshots_update_main_authenticated'
  ) THEN
    DROP POLICY app_state_snapshots_update_main_authenticated ON public.app_state_snapshots;
  END IF;
END;
$$;
