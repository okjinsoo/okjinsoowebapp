        ...
        <main className="min-h-screen bg-gray-50 flex justify-center py-12 px-4 sm:px-6 lg:px-8">
            <div className="max-w-3xl w-full bg-white rounded-2xl shadow-sm border border-gray-200 p-8 sm:p-12 mb-12">
                ...
                <article className="prose prose-sm sm:prose-base prose-gray max-w-none">
                    ...
                    <ol className="list-decimal pl-5 space-y-2 text-gray-700 mb-6 marker:text-gray-400">
                        <li>서비스 개시 전(첫 수업 개시일 전일까지) 취소 요청 시에는 이미 납부한 수강료 전액을 환불합니다.</li>
                        <li>
                            서비스 개시 후에는 <strong>(잔여 수업 시간 / 총 등록 수업 시간)</strong>의 비율에 따라 일할 환불합니다.
                        </li>
                        <li>
                            <strong>당일 예정 수업의 처리</strong>: 1:1 맞춤 예약 교습의 특성 및 강사 일정 점유에 따라, 수업 시작 12시간 이내 또는 수업 당일에 취소 및 환불을 요청하시는 경우, 해당 당일 예정된 수업 시간은 이미 제공된 것으로 간주하여 잔여 수업 시간 계산에서 제외 후 정산됩니다.
                        </li>
                        <li>환불은 「전자상거래 등에서의 소비자보호에 관한 법률」 및 「소비자분쟁해결기준(교육·문화 분야)」을 준수합니다.</li>
                        <li>무단 결석은 환불 정산 시 보강 대상에 포함되지 않으며, 이미 차감된 회차는 잔여 수업 시간에서 제외됩니다.</li>
                    </ol>
