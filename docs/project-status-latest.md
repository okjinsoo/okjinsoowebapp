...
- 2026-03-24 19:58 (KST) 기준, 위 프로덕션 배포가 최신 운영 반영본입니다.
- 2026-03-24 19:58 (KST) 기준, Google 401 자동 재연결/루프 방지 + 관리자/선생님 회차 동기화 정책 보강 패치는 로컬 코드 반영 완료(운영 미배포) 상태입니다.
