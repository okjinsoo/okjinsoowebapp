...
기준 시각: 2026-08-18 11:32 (KST)
대상 프로젝트: `v1`

## 1분 요약

- 최신 운영 반영본: 2026-08-18 11:32 (KST)
- 운영 주소: `https://okjinsoowebapp.vercel.app`
- 사업자 정보 필수 푸터(`AppFooter.tsx`) 전 페이지 적용: 상호(옥진수학), 대표자(옥진수), 사업자등록번호(612-24-93399), 주소, 연락처, 이메일, 이용약관 링크 상시 노출 (전자상거래법/PG 심사 기준 완벽 준수)
