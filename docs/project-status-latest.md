...
- 운영 주소(현재 프로덕션 alias): `https://okjinsoowebapp.vercel.app`
- 운영 alias 참고: `https://okjinsoowebapp-okjinsoos-projects.vercel.app`
...
- 2026-04-17 11:58 (KST) 프로덕션 배포 완료: `dpl_3Asnz7LkFzoHvfg2pv8ep5nyk6GP`
- 2026-04-19 13:04 (KST) 프로덕션 배포 완료: `dpl_9edAKC9nNbvpuahWeHerpBV6zdU2`
- 2026-04-21 20:51 (KST) 프로덕션 배포 완료: `dpl_iqUrZJ6zyRdhDpjigHcmQwkW5rhC`
- 2026-04-21 20:51 (KST) 기준, 위 프로덕션 배포가 최신 운영 반영본입니다.
...
- 위 변경사항은 2026-04-17 11:58 (KST) 프로덕션 배포(`dpl_3Asnz7LkFzoHvfg2pv8ep5nyk6GP`)에 반영되었습니다.
...
13. 회차 학습 카드 편집/오답 노트 UX 보강 (2026-04-17, 코드 반영)
- `smain/session/[index]`에서 `+ 문제 추가`, `+ 공지`로 생성한 카드 상단에 `수정` 버튼을 추가했습니다.
- `수정` 버튼 클릭 시 기존 입력값을 불러와 같은 모달에서 즉시 수정 저장할 수 있습니다.
- 상단 액션에 `+ 오답 노트` 버튼을 추가했습니다.
- 오답 노트 카드는 제목 `📕 오답노트`로 생성되며 문제 URL 없이 `오답 노트 제출` 단일 제출 버튼만 제공합니다.
- 오답 노트 제출은 Drive 업로드 모달과 연동되며 완료/초기화 상태를 개별 관리합니다.
- 위 변경사항은 2026-04-21 20:51 (KST) 프로덕션 배포(`dpl_iqUrZJ6zyRdhDpjigHcmQwkW5rhC`)에 반영되었습니다.
